...
#---------------------------------------------------------------
# This one simulates the gif animation available with the lab
# specification. 
#
# Associativity = 8
# Entries = 5
# Cross word boundaries: No
# Bit Stream: 101 011 110 010 101 (read from R to L) 
#
# Register Usage:
#
#       N/A
