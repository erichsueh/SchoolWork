...
class GoBoardUtil(object):
    ...
    @staticmethod
    def my_neighbours(board, neighbors):
        color = board.current_player
        #print("thisruns")
        myneigh = []
        for move in neighbors:
    ...
    @staticmethod
    #returns all the liberties of that point and the block
    ...
    def generate_all_policy_moves(board,pattern,check_selfatari):
        ...
        myneigh = GoBoardUtil.my_neighbours(board,neighbors)
        color = board.current_player
        #print(color)
        #print(myneigh)
        adef = []
        ...
        surlib = GoBoardUtil.surrlib(board,neighbors)
        surlibn = []
        opp = []
        for lib in surlib:
